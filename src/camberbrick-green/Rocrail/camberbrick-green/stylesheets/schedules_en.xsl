...
<xsl:template match="/">
  ...
  <table border="1" rules="all" cellpadding="4" cellspacing="0" width="100%">
	  ...
	  <TR>
	     ...
	     <TH width="15%" height="30" bgcolor="lightgrey">Time processing</TH>
	     <TH width="30%" height="30" bgcolor="lightgrey">Start schedule</TH>
	     <TH width="35%" height="30" bgcolor="lightgrey">Output</TH>
	  </TR>
      </THEAD> 
      <TBODY>
        <xsl:apply-templates/>
...
<xsl:template match="sc">  
	...
	<TR>
     ...
     <xsl:variable name="timeprocessing" select="@timeprocessing" />
	   <TD align="center">
	   <xsl:choose>
             <xsl:when test="$timeprocessing = '0'">
                <xsl:text>Absolute</xsl:text>
             </xsl:when>
	     <xsl:when test="$timeprocessing = '1'">
    ...
    <table border="0" rules="all" cellpadding="4" cellspacing="0" width="100%">
	  ...
	  <TR>
	     ...
	     <TH width="25%" height="30" bgcolor="white">Hour</TH>
