...
<!-- 
	xsl Template for Locomotives report
...
-->
	...
	<!-- Variable for Background color in Title Cell -->
  ...
  <xsl:template match="/">
    ...
    <html>
	<head>
        <title>Rocrail Locomotives report</title>
	</head>
	<body style="font-family:Arial, Helvetica, sans-serif">

		<!--
		<h2>Active Locomotives report</h2>
		<xsl:for-each select="/*/lclist/lc[@show='true']">	
		-->
		
		<h2>All Locomotives report</h2>
		...
		<TR> <!-- 1. Zeile Main Table -->
			...
			<TD width="20%" valign="top">
				<table border="1" rules="all" cellpadding="4" cellspacing="0" width="100%"  style="font-family:Arial, Helvetica, sans-serif; font-size:11px">
					<!-- Short ID -->
					<TR>
						<TH width="40%" bgcolor="{$bgcolor}">Short ID </TH>	
					...
					<TR>
						...
						<TH width="40%" bgcolor="{$bgcolor}">Run time</TH>
					...
					<TR>
						...
						<TH width="40%" bgcolor="{$bgcolor}">Last run Date</TH>
					...
					<TR>
						...
						<TH width="40%" bgcolor="{$bgcolor}">Last Revision</TH>
			...
			<TD width="20%" valign="top">
				...
				<table border="1" rules="all" cellpadding="4" cellspacing="0" width="100%"  style="font-family:Arial, Helvetica, sans-serif; font-size:11px">
					...
					<!-- Antrieb -->
					<TR>
						<TH width="40%" bgcolor="{$bgcolor}">Engine</TH>
					  <TD align="left">
						...
						<xsl:choose>
						  ...
						  <xsl:when test="$engine = 'automobile'">
							<xsl:text>Automobile or truck</xsl:text>
						  </xsl:when>
						  <xsl:when test="$engine = 'battery'">
							<xsl:text>Battary</xsl:text>
						  </xsl:when>
						  <xsl:otherwise>
					...
					<!-- Train type -->
					<TR>
						<TH width="40%" bgcolor="{$bgcolor}">Train type</TH>
					...
					<!-- Zuglänge -->
					<TR>
						<TH width="40%" bgcolor="{$bgcolor}">Train (length)</TH>						
			...
			<TD width="20%" valign="top">
				<table border="1" rules="all" cellpadding="4" cellspacing="0" width="100%"  style="font-family:Arial, Helvetica, sans-serif; font-size:11px">
					...
					<!-- v_cru -->
					<TR>
						<TH width="40%" bgcolor="{$bgcolor}">V_Cru</TH>	
					...
					<!-- v_mod -->
					<TR>
						<TH width="40%" bgcolor="{$bgcolor}">V_Mode</TH>							  
					...
					<!-- Blockwartezeit -->	
					<TR>
						<TH width="40%" bgcolor="{$bgcolor}">Block wait time</TH>		
					...
					<TR>
						<TH width="40%" bgcolor="{$bgcolor}">Use own wait time in blocks</TH>	
					...
					<!-- Verwende ShortIn -->
					<TR>
						<TH width="40%" bgcolor="{$bgcolor}">Use shortin</TH>
					...
					<!-- Stop bei Pre2In -->
					<TR>
						<TH width="40%" bgcolor="{$bgcolor}">Use Pre2In</TH>							
